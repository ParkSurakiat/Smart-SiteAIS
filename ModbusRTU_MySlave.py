...
while True:
    ...
    def Mod():
        ...
        try:
            ...
            master.execute(1, cst.WRITE_MULTIPLE_REGISTERS, 1, output_value=register_values_cabinetf)
            master.execute(1, cst.WRITE_MULTIPLE_REGISTERS, 10, output_value=register_values_cabinets)
            read_rtu = master.execute(1, cst.READ_HOLDING_REGISTERS, 16, 17)
            # รับจากWacthdog
